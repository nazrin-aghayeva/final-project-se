...
public class UserController {
    ...
    public ResponseEntity<UserResp> editUser(@PathVariable String userId, @RequestBody UserReq request) {
        return ResponseEntity.ok(userService.edit(userId, request));
    }

    @DeleteMapping("delete/{userId}")
    public ResponseEntity<UserResp> deleteUser(@PathVariable String userId) {
